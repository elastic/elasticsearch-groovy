...
|---------------------|-----------------------------|---------------|--------|
| 2.1.1-SNAPSHOT      | 2.1.1-SNAPSHOT              | 7u60 or later | 2.4.4  |
| 2.1.0               | 2.1.0                       | 7u60 or later | 2.4.4  |
...
dependencies {
  compile 'org.elasticsearch:elasticsearch-groovy:2.1.0'
}
```
...
dependencies {
  ...
  compile group: 'org.elasticsearch', name: 'elasticsearch-groovy', version: '2.1.0', classifier: 'grails'
}
```
