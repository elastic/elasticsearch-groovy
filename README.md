...
|---------------------|-----------------------------|---------------|--------|
| [master [5.0]](https://github.com/elastic/elasticsearch) | Build from source [5.0] | 8 or later    | 2.4.5  |
| [2.1 - 2.4](https://github.com/elastic/elasticsearch/tree/2.1) | [2.1](https://github.com/elastic/elasticsearch-groovy/tree/2.1) | 7u60 or later | 2.4.4  |
