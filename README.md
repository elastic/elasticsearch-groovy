...
|---------------------|-----------------------------|---------------|--------|
| 1.5.3-SNAPSHOT      | 1.5.3-SNAPSHOT              | 7u60 or later | 2.4.1  |
...
dependencies {
  compile 'org.elasticsearch:elasticsearch-groovy:1.5.2'
}
```
...
dependencies {
  ...
  compile group: 'org.elasticsearch', name: 'elasticsearch-groovy', version: '1.5.2', classifier: 'grails'
}
```
